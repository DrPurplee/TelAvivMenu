...
local Library = { 
    ...
    Current = nil,
            ...
            local Items = { } do 
                ...
                -- Patched by FocusOnTop/ChatGPT: la sidebar devient scrollable.
                -- Ça évite que les onglets débordent sur l'avatar quand il y a trop de pages.
    ...
    Items["VersionLogo"] = Library:Create("ImageLabel", {
        ...
        BackgroundTransparency = 1,
        Position = UDim2.new(0, 450, 0.5, 0),
